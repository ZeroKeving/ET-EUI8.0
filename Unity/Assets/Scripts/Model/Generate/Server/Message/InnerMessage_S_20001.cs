...
//登录Gate信息
	...
	{
		public static LoginGateInfoProto Create(bool isFromPool = false) 
		{ 
	...
	{
		public static R2G_GetLoginGameKey Create(bool isFromPool = false) 
		{ 
	...
	{
		public static G2R_GetLoginGameKey Create(bool isFromPool = false) 
		{ 
